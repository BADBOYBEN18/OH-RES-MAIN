"""
Django settings for ohres project.
...
SECRET_KEY = 'django-insecure-p$0ur$vgk5*1sxyig#mu9dls992^8o93%im)xl15zf*0#d(-n8'
...
WSGI_APPLICATION = 'ohres.wsgi.application'
